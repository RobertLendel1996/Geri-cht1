(() => {
    ...
    da.init();
    let slideinst = document.querySelectorAll(".slide-gallery");
    slideinst.forEach((slideinst => {
        slideinst.addEventListener("click", (function(e) {
            slideinst.classList.toggle("_open");
        }));
    }));
    window["FLS"] = true;
    isWebp();
